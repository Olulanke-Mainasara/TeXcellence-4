...
export default function Agenda() {
  return (
    <>
      <section className="flex flex-col xl:flex-row items-center max-w-(--breakpoint-xl) justify-center mx-auto h-screen gap-8 pt-20 px-4 md:px-6 xl:px-0">
        <div className="flex items-center">
          <h1 className="text-7xl md:text-9xl tracking-tighter font-semibold">
            Agenda
          </h1>
        </div>
        <div className="max-w-(--breakpoint-sm) overflow-y-scroll">
